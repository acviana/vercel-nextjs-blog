...
This is my 3rd weekly sabbatical summary. I'm pleased that this week's post started to feel more like the quick and direct writing process I'm working towards. As with past weeks, I continue to be pleasantly surprised by the amount of engagement these posts generate. I hope you enjoy it.
...
My most exiting update this week is that I got to do some hands-on work for two companies in addition to my self-study and side projects. I've been giving advice to 1-2 companies or investors a week during my sabbatical but this is the first time I gotten to help out with a technical problem. The first was a web scraper and the second is an LLM application.
...
**Prompt engineering:** The second project is an on-going effort to help a pre-seed founder with some generative AI prompt engineering and QA validation. The context is  specific use case for medical document summarization. This is a really interesting project for me. I've been using generative AI both locally and via ChatGPT for a nearly a year but this is my first time getting to do so for a commercial use-case. I'm early but already learning a lot.
...
**Neovim:** I've been using Neovim casually for most of 2024. But, as I've been [telling folks](https://x.com/AlexVianaPro/status/1829908268929728957), watching me use Neovim is like watching a caveman trying to rub two Teslas together to make fire. I'm slowly getting better at learning the key mappings and installing the extensions I need but what I really need to do is rip off the band-aid and start customizing my setup.
